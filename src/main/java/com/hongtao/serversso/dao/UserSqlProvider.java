...
import com.hongtao.serversso.bean.UserExample.Criteria;
import com.hongtao.serversso.bean.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getLogin() != null) {
            sql.VALUES("login", "#{login,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLogin() != null) {
            sql.SET("login = #{record.login,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getLogin() != null) {
            sql.SET("login = #{login,jdbcType=INTEGER}");
        }
